...
public class DialogUtil {
    ...
    public static AProgressDialog createForProDlg(Context context) {
        AProgressDialog dlg = createProgressDialog(context);
    ...
    private static Dialog createShareActionSheet(Context ctx, String title,
    ...
    public void showProfileShareDialog(final Context context,
        ...
        shareDialog = createShareActionSheet(context, "分享到", "取消", actions,
    ...
    public void showEventDialog(final Context context, final Event event,
        ...
        actions.add(new ActionItem(2, "朋友圈",
                isInstallWechat ? R.drawable.img_wechat_circle
                        : R.drawable.img_wechat_circle_disabled));
        actions.add(new ActionItem(3, "复制链接", R.drawable.img_link));

        shareDialog = createShareActionSheet(context, "分享到", "取消", actions, 3,
     ...
     * 资讯分享Dialog
     */
    public void showInfoDialog(final Context context, ZHInfo info, final String pageName) {
        if (shareDialog != null && shareDialog.isShowing()) {
            return;
        }
        final boolean isInstallWechat = WechatUtil.getInstance()
        ...
        shareDialog = createShareActionSheet(context, "分享到", "取消", actions, 2,
                new OnShareActionClick() {
    ...
    public void showInviteFriendComment(final Context context, TaskCommentDetail data) {
        ...
        shareDialog = createShareActionSheet(context, "发送至", "取消", actions, 2,
                new OnShareActionClick() {
