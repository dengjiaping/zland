 ...
 * 密码登录
 */
public class TaskLoginByPwd extends TaskBase<LoginResponse, Object> {

	private String phone;
    private String pwd;

	public TaskLoginByPwd(Object context, String phone, String pwd,
	...
	public void execute() {
		...
		params = this.put(params, "password", pwd);
