...
public class TabHome extends FragBaseTabPageActivity implements IHomeInterceptView {
    ...
    public static final int TAB_ID_INFO = 1;
    public static final int TAB_ID_EVENT = 2;
    ...
    protected Fragment createTabPage(ZHTabInfo tabInfo) {
        switch (tabInfo.tabId) {
            ...
            case TAB_ID_EVENT: {
                fragEventTab = new FragEvent();
                return fragEventTab;
            }
            case TAB_ID_Find: {
                fragFindTab = new FragFindTab();
                return fragFindTab;
            }
            case TAB_ID_IM: {
    ...
    protected ArrayList<ZHTabInfo> tabToAdded() {
        ...
        ZHTabInfo tabInfo = new ZHTabInfo("资讯", TAB_ID_INFO);
        tabInfo.arg1 = R.drawable.sel_tab_info;
        tabs.add(tabInfo);

        tabInfo = new ZHTabInfo("活动", TAB_ID_EVENT);
        tabInfo.arg1 = R.drawable.sel_tab_event;
        tabs.add(tabInfo);
    ...
    public void refreshTitleFreshTask(boolean showFreshTask, boolean showRedDot) {
        ...
        if (fragEventTab != null) {
            fragEventTab.refreshTitleFreshTask(showFreshTask, showRedDot);
        }
        if (fragFindTab != null) {
