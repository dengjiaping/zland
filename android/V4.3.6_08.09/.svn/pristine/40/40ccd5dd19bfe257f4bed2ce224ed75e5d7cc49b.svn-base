...
import com.zhisland.android.blog.contacts.uri.AUriCardAddFriend;
...
import com.zhisland.android.blog.find.uri.AUriAllBoss;
...
public class AUriMgr {
    ...
    private void registerHandlers() throws InstantiationException, IllegalAccessException {
        ...
        this.registerHandler(PATH_USERS, AUriAllBoss.class);
        ...
        this.registerHandler(PATH_ADD_FRIEND_REQUEST, AUriCardAddFriend.class);
    }
}
