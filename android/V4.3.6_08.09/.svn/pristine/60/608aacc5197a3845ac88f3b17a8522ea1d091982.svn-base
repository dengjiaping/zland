...
import com.beem.project.beem.service.pcklistener.FriendInviteFilter;
import com.beem.project.beem.service.pcklistener.FriendInviteMsgListener;
...
public class XmppConnectionAdapter extends IXmppConnection.Stub {
    ...
    private ChatRoomManagerAdapter mChatRoomManagerAdapter;
    ...
    private final FriendInviteMsgListener mInviteMsgListener = new FriendInviteMsgListener();
    private final FriendInviteFilter mInviteFilter = new FriendInviteFilter();
    ...
    public boolean login() throws RemoteException {
        ...
        try {
            ...
            mChatRoomManagerAdapter = new ChatRoomManagerAdapter(mAdaptee,
                    mService);
    ...
    public IChatRoomManager getChatRoomManager() throws RemoteException {
        if (mChatRoomManagerAdapter != null)
            return mChatRoomManagerAdapter;
        mChatRoomManagerAdapter = new ChatRoomManagerAdapter(mAdaptee, mService);
        return mChatRoomManagerAdapter;
    }
    ...
    private void addFilterAndListener() {
        ...
        mAdaptee.addPacketListener(mInviteMsgListener, mInviteFilter);
        mInviteMsgListener.setService(mService, this);
