...
import com.zhisland.android.blog.info.view.impl.adapter.CommentAdapter;
...
public class FragInfoDetail extends FragPullListMvps<Comment> implements IInfoSocialView, IInfoReadView {
    ...
    protected Map<String, BasePresenter> createPresenters() {
        ...
        commentAdapter.setPresenter(infoSocialPresenter);
        return map;
    }
        ...
        wvWrapper.setWebListener(new WVWrapper.WebListener() {
            ...
            public void onPageFinish() {
                if (getReadPresenter() != null) {
                    commentAdapter.setShowEmptyView(true);
    ...
    @Override
    public void showProgressDlg(String text) {
        if (progressDlg == null) {
    ...
    public void showSendCommentView(SendCommentView.ToType toType, String toName, Long newsId, Long commentId, Long replyId) {
        sendCommentView.show(toType, toName, newsId, commentId, replyId);
    }
    ...
    void sendCommentClick() {
        getSocialPresenter().wantSendComment(SendCommentView.ToType.info, null, null, null);
    }
