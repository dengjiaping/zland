...
public class FragSettings extends FragBase {
	...
	private AProgressDialog progDialog;
	...
	protected void removeClearProDialog() {
		if (progDialog != null && progDialog.isShowing()) {
			progDialog.cancel();
		}
	}

	private void showClearProDialog() {
		progDialog = DialogUtil.createProgressDialog(getActivity());
		progDialog.setText("请稍候，正在清除缓存...");
