...
interface IXmppFacade {
    ...
    boolean addFriend( in String msg);
    
    boolean acceptFriend( in String jid);

    boolean ignoreInvite( in String jid);

    boolean promoteFriend( in String jid);

    boolean downgradeFriend( in String jid);

    boolean blockFriend( in String jid);
