 ...
 * Original file: /Users/lipengju/zhisland/android/V4.4.0_08.29/zhim_lib/src/main/aidl/com/beem/project/beem/service/aidl/IMessageListener.aidl
 */
...
@Override public void onStatusChanged(java.lang.String messageThread, int status, int progress) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(messageThread);
...
public void onStatusChanged(java.lang.String messageThread, int status, int progress) throws android.os.RemoteException;
}
