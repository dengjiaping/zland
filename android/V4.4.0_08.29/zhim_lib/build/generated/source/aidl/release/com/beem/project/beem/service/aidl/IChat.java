 ...
 * Original file: /Users/lipengju/zhisland/android/V4.4.0_08.29/zhim_lib/src/main/aidl/com/beem/project/beem/service/aidl/IChat.aidl
 */
...
case TRANSACTION_getParticipantJid:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getParticipantJid();
reply.writeNoException();
...
/**
	 ...
	 */
@Override public java.lang.String getParticipantJid() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getParticipantJid, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_getParticipantJid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
...
/**
	 ...
	 * @return the participant
	 */
public java.lang.String getParticipantJid() throws android.os.RemoteException;
/**
	 * Add a message listener.
	 * @param listener the listener to add.
	 */
