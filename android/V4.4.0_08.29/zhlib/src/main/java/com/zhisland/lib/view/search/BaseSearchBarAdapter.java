...
public abstract class BaseSearchBarAdapter extends BaseAdapter implements
	...
	private static final String CLEAR_HISTORY = new String("清除历史纪录");

	// 筛选器
	private ArrayFilter mFilter;
	// 搜索监听器
	private final ZHSearchListener searchListener;
	 ...
	 *            history
	 */
	public BaseSearchBarAdapter(ZHSearchListener searchListener) {
