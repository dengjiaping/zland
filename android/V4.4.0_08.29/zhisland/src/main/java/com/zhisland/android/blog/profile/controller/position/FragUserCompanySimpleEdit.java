...
public class FragUserCompanySimpleEdit extends FragBase {
    ...
    private void setAuthCompany() {
        ...
        if (company.isAuthentication != null && company.isAuthentication == 1) {
            ...
            if (user != null) {
                if (user.isGoldVip()) {
                    ivIndentify.setImageResource(R.drawable.img_renzheng_daolin_all_y);
                } else if (user.isBlueVip()) {
                    ivIndentify.setImageResource(R.drawable.img_renzheng_daolin_all_b);
                } else {
                    ivIndentify.setImageResource(R.drawable.img_renzheng_daolin_all_g);
                }
            } else {
                ivIndentify.setImageResource(R.drawable.img_renzheng_daolin_all_g);
            }
        } else if (company.isClientAuth != null && company.isClientAuth == 1) {
            ivIndentify.setImageResource(R.drawable.img_renzheng_haike_all);
        }
