...
public class FragChat extends FragPullList<IMMessage> implements
    ...
    protected IMUser mContact;
    protected IMUser lastChatContact;
    private IChat mChat;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContact = (IMUser) getActivity().getIntent().getSerializableExtra(ActChat.INK_CONTACT);
     ...
     */
    private void changeCurrentChat(IMUser contact) throws RemoteException {
    ...
    private boolean isFirstChatChange(IMUser contact) {
    ...
    protected void send(Message msg) {
        IMUser ic = DBMgr.getHelper().getUserDao()
                .getByJid(mContact.jid);
        //edit by xiangfei, 好友关系改为关注关系
