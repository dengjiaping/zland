...
public class UserContactGroupBlock extends ProfileBaseCustomBlock<UserContactInfo> {
    ...
    private void fillRefereeView() {
        ...
        if (refereeInfo != null) {
            ...
            if (refereeInfo.activity != User.VALUE_ACTIVITY_NORMAL) {
                tvReferee.setTextColor(getResources().getColor(R.color.color_f3));
                tvReferee.setCompoundDrawables(null, null, null, null);
                tvReferee.setEnabled(false);
            }
        } else {
