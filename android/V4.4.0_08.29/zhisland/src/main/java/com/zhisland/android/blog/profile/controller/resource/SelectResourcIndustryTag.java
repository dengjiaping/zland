 ...
 * 选择公司行业
 * <p>
 * 调起：SelectIndustryTag.launch(this, null, 123);
 * <p>
 * 回调：
 * <p>
 * <code>
 ...
 * 
 */
public class SelectResourcIndustryTag {

	private static final SelectDataListener INDUSTRY_SELECT_LISTENER = new SelectDataListener() {
	...
	public static void launch(Activity activity, ZHDicItem selectedItem,
		...
		param.dataListener = INDUSTRY_SELECT_LISTENER;
		param.title = "类别标签";
		param.max = 1;
