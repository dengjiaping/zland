...
public class FragProfileDetailHeader extends FragBase implements
    ...
    @InjectView(R.id.tvAttentionNum)
    TextView tvAttentionNum;
    @InjectView(R.id.tvFansNum)
    TextView tvFansNum;
    @InjectView(R.id.tvHotNum)
    TextView tvHotNum;
    ...
    private void setDataToView() {
        showFigureView();
        tvName.setText(user.getNameWithTypeGoldFire(getActivity(), true));
        tvComAndPos.setText((user.userCompany == null ? ""
                : (user.userCompany + " "))
                + (user.userPosition == null ? "" : user.userPosition));
        if (user.relationReport != null) {
            tvAttentionNum.setText(user.relationReport.attentionCount + "关注");
            tvFansNum.setText(user.relationReport.fansCount + "粉丝");
            tvHotNum.setText(user.relationReport.heatVal + "热度");
        }
    }
