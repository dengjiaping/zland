package com.zhisland.android.blog.common.view.flingswipe;
...
public class FlingCardListener implements View.OnTouchListener {
	...
	public boolean onTouch(View view, MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			// in this area would be code for doing something with the view
			// the frame moves.
			frame.setX(aPosX);
			// frame.setY(aPosY);
	...
	public void selectRight() {
		if (!isAnimationRunning) {
			...
			mFlingListener.onRightExitAnim();
		}
	}
