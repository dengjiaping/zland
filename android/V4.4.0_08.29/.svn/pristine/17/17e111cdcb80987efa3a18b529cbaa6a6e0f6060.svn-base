...
public class FragResultBoss extends FragPullList<User> {
    ...
    public static final String INTENT_KEY_UTYPE = "intent_key_utype";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        initialUType = getActivity().getIntent().getStringExtra(INTENT_KEY_UTYPE);
        if (cacheKey != null && StringUtil.isNullOrEmpty(initialUType)) {
    ...
    private synchronized void search(final String searchWord, final String maxId) {
        ...
        apiKey = new Object();
        if(!StringUtil.isNullOrEmpty(initialUType)){
            codeUType = initialUType;
        }
        final boolean noFilter = codeUType == null && codeArea == null;
