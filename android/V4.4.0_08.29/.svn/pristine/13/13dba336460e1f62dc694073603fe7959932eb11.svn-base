...
public class FragProfileVisitorSelf extends FragBase implements IProfileView {
    ...
    private void onUpdate() {
        if (userDetail != null) {
            ...
            SimpleBlock<UserContactInfo> contactBlock = userDetail.getContactGroupBlock();
            if (contactBlock != null && contactBlock.data != null) {
                for (UserContactInfo contact : contactBlock.data) {
            ...
            if (userContact != null && !StringUtil.isNullOrEmpty(userContact.mobile)) {
                tvPhone.setText(userContact.mobile);
            ...
            if (userContact != null && !StringUtil.isNullOrEmpty(userContact.email)) {
                tvEmail.setText(userContact.email);
