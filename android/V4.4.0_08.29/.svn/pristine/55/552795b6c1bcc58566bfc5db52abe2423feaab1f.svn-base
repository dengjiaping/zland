...
public class FragUserAssistant extends FragBase {
	...
	ActionItem actionItemNo = new ActionItem(
			UserAssistant.VALUE_CONTACT_VISIBLE_RANGE_NO, R.color.color_dc,
			UserAssistant.NAME_CONTACT_VISIBLE_RANGE_NO);
	...
	private void setWhoCanSeeView() {
		...
		case UserAssistant.VALUE_CONTACT_VISIBLE_RANGE_FRIEND:
			...
			break;
		case UserAssistant.VALUE_CONTACT_VISIBLE_RANGE_NO:
