...
public class BitmapUtil {
     ...
     * 微信分享bitmap
     */
    public static Bitmap getWechatThumbBitmap(final String path,
    ...
    public static Bitmap captureScreen(Activity activity) {
        ...
        int statusBarHeight = DensityUtil.getStatusHeight();
        int width = DensityUtil.getWidth();
        int height = DensityUtil.getHeight();
        Bitmap tempBmp = Bitmap.createBitmap(bmp, 0, statusBarHeight, width,
